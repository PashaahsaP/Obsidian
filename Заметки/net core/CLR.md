##CLR (Common Language Runtime) - общеязыковая среда выполнения реализующая CLI стандарт. Отвечает за управление исполнением кода  и предоставляет различные сервисы облегчающие разработку.
